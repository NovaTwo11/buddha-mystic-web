...
export default function OurPromise() {
    return (
        <section className="bg-[#FCFBF9] dark:bg-[#0A0A0A] py-24 lg:py-32 px-5 sm:px-12 lg:px-16 relative overflow-hidden flex items-center justify-center transition-colors duration-500">
            ...
            <div className="absolute right-[-10%] top-1/2 -translate-y-1/2 opacity-[0.03] dark:opacity-[0.02] pointer-events-none select-none transform rotate-12 transition-opacity duration-500">
                <svg width="800" height="800" viewBox="0 0 24 24" fill="currentColor" className="text-gray-900 dark:text-white">
            ...
            <div className="max-w-[1600px] w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
                ...
                {/* =========================================
                    LADO IZQUIERDO: El Arco del Santuario
                    ========================================= */}
                <div className="lg:col-span-5 relative w-full max-w-md mx-auto lg:max-w-none">
                    ...
                    <div className="absolute -bottom-8 -right-4 sm:-right-8 z-20 bg-white/90 dark:bg-[#1A1A1A]/90 backdrop-blur-xl p-5 sm:p-6 rounded-2xl shadow-xl border border-white/60 dark:border-white/10 transform hover:-translate-y-2 transition-all duration-500">
