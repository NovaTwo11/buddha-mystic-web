...
export default function FeatureGrid() {
    ...
    const features = [
        ...
        },
        {
            ...
            description: t('experiences_desc'),
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                ...
                <div className="text-center mb-24 flex flex-col items-center">
                    ...
                    <h2 className="text-4xl md:text-5xl font-serif text-gray-900 dark:text-white font-light mb-8 transition-colors duration-500">
                        {t('title_p1')} <span className="italic text-[#D4AF37] font-medium normal-case">{t('title_highlight')}</span>
                    </h2>
