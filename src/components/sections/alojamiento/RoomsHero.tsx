    ...
    return (
        <section className="relative w-full min-h-[90vh] flex items-center pt-32 pb-16 lg:pt-40 lg:pb-20 bg-[#FCFBF9] dark:bg-[#0A0A0A] transition-colors duration-500">
            ...
            <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                {/* Reemplazamos el div genérico por nuestro MysticImage optimizado */}
                <MysticImage
                    src="Foto_habitacion_1.1_gympjb"
                    alt="Santuario de Descanso - Habitaciones en Buddha Mystic"
                    width={1920}
                    height={1080}
                    priority={true}
                ...
                {/* Capa sutil adaptativa para unificar tonos y asegurar legibilidad */}
