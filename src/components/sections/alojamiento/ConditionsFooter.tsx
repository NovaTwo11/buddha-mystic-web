export default function ConditionsFooter() {
    return (
        <section className="w-full bg-white dark:bg-[#0A0A0A] border-t border-gray-100 dark:border-white/5 py-10 px-4 sm:px-8 mt-8 overflow-hidden transition-colors duration-500">
            <div className="max-w-[1600px] mx-auto flex flex-col lg:flex-row items-center justify-center lg:space-x-12 text-center lg:text-left text-xs text-gray-500 dark:text-gray-400 font-light tracking-wide space-y-6 lg:space-y-0">

                <div className="flex items-center space-x-3 group">
                    <div className="p-2 rounded-full bg-[#FAFAFA] dark:bg-[#111111] group-hover:bg-[#D4AF37]/10 dark:group-hover:bg-[#D4AF37]/20 transition-colors duration-300">
                    ...
                    <span>Tarifas <span className="font-medium text-gray-800 dark:text-white transition-colors duration-500">NO incluyen IVA</span>.</span>
                </div>

                <div className="hidden lg:block w-px h-6 bg-gray-200 dark:bg-gray-800 transition-colors duration-500"></div>

                <div className="flex items-center space-x-3 group">
                    <div className="p-2 rounded-full bg-[#FAFAFA] dark:bg-[#111111] group-hover:bg-[#00A896]/10 dark:group-hover:bg-[#00A896]/20 transition-colors duration-300">
