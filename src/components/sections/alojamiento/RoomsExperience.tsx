...
const rooms = [
    {
        id: 1, slug: 'individual', name: 'Individual', capacity: '1 persona', filter: 'Silencio y Desconexión', energy: 'Ideal para Introspección', lowPrice: '$150.000', highPrice: '$250.000',
        img: 'https://images.unsplash.com/photo-1552566626-52f8b828add9?q=80&w=2070&auto=format&fit=crop'
    },
    {
        id: 2, slug: 'pareja', name: 'Pareja', capacity: '2 personas', filter: 'Silencio y Desconexión', energy: 'Refugio de Paz', lowPrice: '$150.000', highPrice: '$250.000',
        img: 'https://images.unsplash.com/photo-1590490360182-c33d57733427?q=80&w=1974&auto=format&fit=crop'
    },
    {
        id: 3, slug: 'superior', name: 'Superior', capacity: '2 personas', filter: 'Romance y Conexión', energy: 'Amplitud y Armonía', lowPrice: '$170.000', highPrice: '$270.000',
    ...
    {
        id: 8, slug: 'acomodacion-10-pax', name: 'Acomodación 10 pax', capacity: '10 personas', filter: 'Grupos de Sanación', energy: 'Círculo de Luz', lowPrice: '$620.000', highPrice: '$900.000',
        img: 'https://images.unsplash.com/photo-1618221118493-9cfa1a1c00da?q=80&w=2232&auto=format&fit=crop'
    },
    {
        id: 9, slug: 'acomodacion-12-pax', name: 'Acomodación 12 pax', capacity: '12 personas', filter: 'Grupos de Sanación', energy: 'Retiro Colectivo', lowPrice: '$700.000', highPrice: '$1.000.000',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
                {filteredRooms.map((room) => (
                    <div key={room.id} className="group relative flex flex-col bg-white border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 rounded-sm overflow-hidden">
                        ...
                        {/* Image Box convertido en Link interactivo */}
                        <Link href={`/alojamiento/${room.slug}`} className="relative h-64 w-full overflow-hidden block cursor-pointer">
                            <div
                        ...
                        <div className="p-6 md:p-8 flex flex-col flex-grow">
                            <div className="flex justify-between items-start mb-6">
                                ...
                                {/* Menú del Buen Descanso Tooltip */}
                            ...
                            {/* Botón convertido en enlace a la vista de detalle */}
                            <Link
                                href={`/alojamiento/${room.slug}`}
                                className="w-full py-3.5 px-4 bg-transparent border border-[#D4AF37] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-white transition-colors duration-500 font-light tracking-[0.2em] text-[10px] md:text-xs uppercase rounded-sm text-center block"
                            >
