                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16 text-center md:text-left">
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        ...
                        <ul className="space-y-4 text-sm text-gray-500 dark:text-gray-400 font-light flex flex-col items-center md:items-start transition-colors duration-500">
                            ...
                            <li>
                                <a href="https://wa.me/573135431537" target="_blank" rel="noopener noreferrer" className="hover:text-[#D4AF37] dark:hover:text-[#00A896] transition-colors duration-300">
                                    WhatsApp: +57 313 543 1537
                                </a>
                            </li>
                            <li>
                                <a href="mailto:buddhamystichotel@gmail.com" className="hover:text-[#D4AF37] dark:hover:text-[#00A896] transition-colors duration-300">
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        ...
                        <div className="flex justify-center md:justify-start space-x-5 mb-8">
                            <a href="https://instagram.com/buddhamystichotel" target="_blank" rel="noopener noreferrer" className="text-gray-400 dark:text-gray-500 hover:text-[#00A896] dark:hover:text-[#D4AF37] transition-colors duration-300" aria-label="Instagram">
                            ...
                            <a href="https://facebook.com/Hotelbuddhamystic" target="_blank" rel="noopener noreferrer" className="text-gray-400 dark:text-gray-500 hover:text-[#00A896] dark:hover:text-[#D4AF37] transition-colors duration-300" aria-label="Facebook">
                                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
