...
export default function Navbar() {
    ...
    // Alternamos el tema interactuando directamente con el DOM, mucho más rápido y sin redibujos innecesarios
    const toggleTheme = () => {
                ...
                <div className="flex justify-between items-center h-24">
                    ...
                    <div className="hidden md:flex items-center space-x-6">
                        ...
                        <div className="flex items-center space-x-3 border-r border-gray-200 dark:border-gray-800 pr-6">
                            ...
                            {/* Modo Claro/Oscuro con lógica CSS en lugar de estado React */}
                            <button
                                onClick={toggleTheme}
                            ...
                            >
                                {/* Sol: Oculto por defecto, visible en dark mode */}
                                ...
                                {/* Luna: Visible por defecto, oculto en dark mode */}
                        ...
                        <a
                            ...
                            className="relative overflow-hidden group bg-[#D4AF37] px-8 py-3 text-[10px] tracking-[0.25em] uppercase font-bold transition-all duration-500 shadow-[0_0_20px_rgba(212,175,55,0.25)] hover:shadow-[0_0_25px_rgba(0,168,150,0.3)]"
                        >
                ...
                <div className="px-6 py-8 flex flex-col space-y-6">
                    ...
                    <div className="pt-6 border-t border-gray-100 dark:border-gray-800 flex flex-col space-y-6">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-center bg-[#D4AF37] text-white px-8 py-4 text-xs tracking-[0.2em] uppercase font-bold hover:bg-[#00A896] transition-colors duration-500"
                        >
                            RESERVAR AHORA
                        </a>
                    </div>
